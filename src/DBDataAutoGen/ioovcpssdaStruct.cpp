...
#include "ioovcpssdaStruct.h"

#define RegisterClassName DBAG::ioovcpssda

std::string& DBAG::ioovcpssdaDBGenDao::getTableName()
{
    static std::string t = "ioovcpssda";
    return t;
}

std::string& DBAG::ioovcpssdaDBGenDao::getPrimarykey()
{
    static std::string t = "md5";
    return t;
}

std::vector<std::string> DBAG::ioovcpssdaDBGenDao::getColumnList()
{
...
RTTR_REGISTRATION
{
    rttr::registration::class_<RegisterClassName>("DBAG::ioovcpssda")
