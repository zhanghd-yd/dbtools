...
#include "ssdfiStruct.h"

#define RegisterClassName DBAG::ssdfi

std::string& DBAG::ssdfiDBGenDao::getTableName()
{
    static std::string t = "ssdfi";
    return t;
}

std::string& DBAG::ssdfiDBGenDao::getPrimarykey()
{
    static std::string t = "md5";
    return t;
}

std::vector<std::string> DBAG::ssdfiDBGenDao::getColumnList()
{
...
RTTR_REGISTRATION
{
    rttr::registration::class_<RegisterClassName>("DBAG::ssdfi")
		.constructor<>()(rttr::policy::ctor::as_std_shared_ptr)
        .property("md5", &RegisterClassName::md5)(rttr::metadata("cn",std::string("编号")))
.property("allsat_l3_path", &RegisterClassName::allsat_l3_path)(rttr::metadata("cn",std::string("输入文件路径")))
.property("allsat_l3_nc", &RegisterClassName::allsat_l3_nc)(rttr::metadata("cn",std::string("输入文件名")))
...
.property("msla_result", &RegisterClassName::msla_result)(rttr::metadata("cn",std::string("输出文件")))
